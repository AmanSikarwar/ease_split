...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(SignedInUser user) authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(SignedInUser user)? authenticated,
...
abstract class Authenticated implements AuthState {
  const factory Authenticated(final SignedInUser user) = _$Authenticated;
